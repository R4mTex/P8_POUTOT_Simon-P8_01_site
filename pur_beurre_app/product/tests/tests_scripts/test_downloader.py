...
def test_downloader_requests(mock_requests_get):
    ...
    assert sut.get_products(1, 1) == [{'name': 'eau de source',
                                     ...
                                     'store': ['carrefour', 'leclerc', 'auchan', 'intermarché', 'super u', 'e.leclerc'],
                                     'url': 'https://fr.openfoodfacts.org/produit/3274080005003/eau-de-source-cristaline',
                                     'img': 'https://images.openfoodfacts.org/images/products/327/408/000/5003/front_fr.901.400.jpg',
                                     'nutriscore': 'a',
                                     'nutriments': {'alcohol': 0, 'alcohol_100g': 0, 'alcohol_serving': 0, 'alcohol_unit': '% vol', 'alcohol_value': 0, 'alpha-linolenic-acid': 0.029,
                                     'alpha-linolenic-acid_100g': 0.029, 'alpha-linolenic-acid_serving': 0.00029, 'alpha-linolenic-acid_unit': 'mg', 'alpha-linolenic-acid_value': 29,
                                     'arachidic-acid': 0.0039, 'arachidic-acid_100g': 0.0039, 'arachidic-acid_serving': 3.9e-05, 'arachidic-acid_unit': 'mg', 'arachidic-acid_value': 3.9,
                                     'arachidonic-acid': 0.0005, 'arachidonic-acid_100g': 0.0005, 'arachidonic-acid_serving': 5e-06, 'arachidonic-acid_unit': 'mg',
                                     'arachidonic-acid_value': 0.5, 'behenic-acid': 3e-05, 'behenic-acid_100g': 3e-05, 'behenic-acid_serving': 3e-07, 'behenic-acid_unit': 'mg',
                                     'behenic-acid_value': 0.03, 'bicarbonate': 0.0025, 'bicarbonate_100g': 0.0025, 'bicarbonate_label': 'Bicarbonate',
                                     'bicarbonate_serving': 2.5e-05, 'bicarbonate_unit': 'mg', 'bicarbonate_value': 2.5, 'biotin': 7.7, 'biotin_100g': 7.7,
                                     'biotin_serving': 0.077, 'biotin_unit': 'g', 'biotin_value': 7.7, 'butyric-acid': 0.00015, 'butyric-acid_100g': 0.00015,
                                     'butyric-acid_serving': 1.5e-06, 'butyric-acid_unit': 'mg', 'butyric-acid_value': 0.15, 'caffeine': 0.0026,
                                     'caffeine_100g': 0.0026, 'caffeine_serving': 2.6e-05, 'caffeine_unit': 'mg', 'caffeine_value': 2.6, 'calcium': 0.0039,
                                     'calcium_100g': 0.0039, 'calcium_label': 'Calcium', 'calcium_serving': 3.9e-05, 'calcium_unit': 'mg', 'calcium_value': 3.9,
                                     'carbohydrates': 0, 'carbohydrates_100g': 0, 'carbohydrates_serving': 0, 'carbohydrates_unit': 'g', 'carbohydrates_value': 0,
                                     'carbon-footprint-from-known-ingredients_product': 600, 'chloride': 0.0005, 'chloride_100g': 0.0005, 'chloride_label': 'Chlorure',
                                     'chloride_serving': 5e-06, 'chloride_unit': 'mg', 'chloride_value': 0.5, 'energy': 0, 'energy-kcal': 0, 'energy-kcal_100g': 0,
                                     'energy-kcal_serving': 0, 'energy-kcal_unit': 'kcal', 'energy-kcal_value': 0, 'energy-kcal_value_computed': 0, 'energy-kj': 0,
                                     'energy-kj_100g': 0, 'energy-kj_serving': 0, 'energy-kj_unit': 'kJ', 'energy-kj_value': 0, 'energy-kj_value_computed': 0,
                                     'energy_100g': 0, 'energy_serving': 0, 'energy_unit': 'kJ', 'energy_value': 0, 'fat': 0, 'fat_100g': 0, 'fat_serving': 0,
                                     'fat_unit': 'g', 'fat_value': 0, 'fiber': 0, 'fiber_100g': 0, 'fiber_serving': 0, 'fiber_unit': 'g', 'fiber_value': 0,
                                     'fluoride': 3e-05, 'fluoride_100g': 3e-05, 'fluoride_label': 'Fluorure', 'fluoride_modifier': '<', 'fluoride_serving': 3e-07,
                                     'fluoride_unit': 'mg', 'fluoride_value': 0.03, 'fr-sulfate': 0.0006, 'fr-sulfate_100g': 0.0006, 'fr-sulfate_label': 'Sulfate',
                                     'fr-sulfate_serving': 6e-06, 'fr-sulfate_unit': 'mg', 'fr-sulfate_value': 0.6, 'fruits-vegetables-nuts-estimate-from-ingredients_100g': 0,
                                     'fruits-vegetables-nuts-estimate-from-ingredients_serving': 0, 'magnesium': 0.0025, 'magnesium_100g': 0.0025,
                                     'magnesium_label': 'Magnésium', 'magnesium_serving': 2.5e-05, 'magnesium_unit': 'mg', 'magnesium_value': 2.5, 'nitrate': 0.001,
                                     'nitrate_100g': 0.001, 'nitrate_label': 'Nitrate', 'nitrate_modifier': '<', 'nitrate_serving': 1e-05, 'nitrate_unit': 'mg',
                                     'nitrate_value': 1, 'nova-group': 1, 'nova-group_100g': 1, 'nova-group_serving': 1, 'nutrition-score-fr': 0,
                                     'nutrition-score-fr_100g': 0, 'ph': 7.7, 'ph_100g': 7.7, 'ph_label': 'PH', 'ph_serving': 7.7, 'ph_unit': 'g', 'ph_value': 7.7,
                                     'potassium': 0.00015, 'potassium_100g': 0.00015, 'potassium_label': 'Potassium', 'potassium_serving': 1.5e-06,
                                     'potassium_unit': 'mg', 'potassium_value': 0.15, 'proteins': 0, 'proteins_100g': 0, 'proteins_serving': 0, 'proteins_unit': 'g',
                                     'proteins_value': 0, 'salt': 0.00475, 'salt_100g': 0.00475, 'salt_serving': 4.75e-05, 'salt_unit': 'mg', 'salt_value': 4.75,
                                     'saturated-fat': 0, 'saturated-fat_100g': 0, 'saturated-fat_serving': 0, 'saturated-fat_unit': 'g', 'saturated-fat_value': 0,
                                     'silica': 0.0026, 'silica_100g': 0.0026, 'silica_label': 'Silice', 'silica_serving': 2.6e-05, 'silica_unit': 'mg', 'silica_value': 2.6,
                                     'sodium': 0.0019, 'sodium_100g': 0.0019, 'sodium_serving': 1.9e-05, 'sodium_unit': 'mg', 'sodium_value': 1.9, 'sugars': 0,
